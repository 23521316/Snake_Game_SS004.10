...
pygame.init()
pygame.mixer.init()
menuchoice=pygame.mixer.Sound("Sound\_menuchoice_sound.mp3")
entergame=pygame.mixer.Sound("Sound\_entergame_sound.mp3")
eatfood=pygame.mixer.Sound("Sound\eat_food_sound.mp3")
specialfood=pygame.mixer.Sound("Sound\_special_food_sound.mp3")
gameover=pygame.mixer.Sound("Sound\_gameover_sound.mp3")
